...
<main>
    <form id="create_product" action="/create-new-product/<?= $_SESSION['user_uuid'] ?>" method="POST" enctype="multipart/form-data" onsubmit="return validate()">
        ...
        <div class="input-pair">
            ...
            <input name="product_subtitle" type="text" value="" placeholder="Enter title" data-validate="str" data-min="1" data-max="50" />
        </div>
        <div class="input-pair">
            <label for="product_price">price</label>
            <input name="product_price" type="text" value="" placeholder="Enter title" data-validate="str" data-min="1" data-max="50" />
        </div>
        <div class="input-pair">
