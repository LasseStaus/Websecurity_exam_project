  ...
  <div class="card-wrapper">
    <div class="card">
      ...
      <div class="product-content">
        ...
        <div class="flex wrap column">
        <div class="master-flex"><p class="small">Created: <span class="small"><?= out($product['product_timestamp']) ?></span></p>  <p class="small">By: <span class="small"><?= out($_SESSION['user_firstname']) ?> <?= out($_SESSION['user_lastname']) ?></span></p></div>
        ...
        <div class="product-price">
          <div class="master-flex"><p class="new-price">Price:</p> <p><span><?= out($product['product_price']) ?></span> DKK</p></div>
